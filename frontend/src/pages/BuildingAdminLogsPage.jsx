...
function BuildingAdminLogsPage() {
  ...
  const searchCount = logs.filter(l => l.action === "NAVIGATION_SEARCH").length;
  const directionsCount = logs.filter(l => l.action === "DIRECTIONS_VIEWED").length;
  const uniqueUsers = [...new Set(logs.map(l => l.actorName))].length;
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 min-h-[75vh]">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-gray-500 text-sm font-light mt-2 uppercase tracking-widest">
                Navigation, searches and actions performed by building users
              </p>
            </div>
            <button
              onClick={loadLogs}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: "Directions Given", value: directionsCount },
...
export default BuildingAdminLogsPage;
